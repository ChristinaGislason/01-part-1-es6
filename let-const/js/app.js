...
function displayPics(){
  ...
  // DONE: This previous line of code returns an error because 'rando' is defined within the code block. When you console.log outside of the code block, it cannot access the 'rando' variable.  
