...
// When joe.scope() is invoked, the "this" keyword is inside an object's method and will refer to the object.  
// 2. What is "this" when joe.scopeArrow() is invoked?
//  When joe.scopeArrow() is invoked, "this" does not exist.
// 3. Explain why "this" is different when an arrow function is used.
// 'This' is different when an arrow function is used because the "this" keyword falls out of scope and now belongs to the window object. 
